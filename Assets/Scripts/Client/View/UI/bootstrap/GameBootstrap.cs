...
namespace MOBANet.UnityView.Core
{
    ...
    public class GameBootstrap : MonoBehaviour
    {
        ...
        [SerializeField] private string _defaultAddress = "213.32.22.234";
        ...
        private string _addressInput = "213.32.22.234";
        ...
        private void Awake()
        {
            // Configure FPS settings - disable VSync and cap at 60 FPS
        ...
        public void StartServer(ushort port)
        {
            ...
            // Force FPS settings (FishNet overrides in its lifecycle)
            StartCoroutine(ForceFPSSettings());
        ...
        /// <summary>
        /// Force FPS settings to 60. FishNet overrides these in LateUpdate, so we force them persistently.
        /// </summary>
        private System.Collections.IEnumerator ForceFPSSettings()
        {
            // Force settings over multiple frames to ensure they stick
            for (int i = 0; i < 10; i++)
            {
                QualitySettings.vSyncCount = 0;
                Application.targetFrameRate = 144;
            ...
            // Continue forcing in LateUpdate
            StartCoroutine(ForceFPSInLateUpdate());
        }

        /// <summary>
        /// Continuously force FPS settings in LateUpdate (after FishNet's override)
        /// </summary>
        private System.Collections.IEnumerator ForceFPSInLateUpdate()
        {
            while (true)
            {
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label("RYVAX", titleStyle, GUILayout.Height(50 * scale));
